...
map<int,Agent_connect*> register_table;
...
void epoll_login(Agent_connect *ptr, int sockfd,uint32_t events, int op)
{
...
void epoll_del(Agent_connect *ptr, int sockfd,uint32_t events, int op)
{
	struct epoll_event ev;
	delete ptr;
	ev.events = events;
